...
from forms import NewSongForPlaylistForm, SongForm, PlaylistForm, DeletePlaylistForm
...
def add_playlist():
    ...
    if form.validate_on_submit():
        ...
        new_p = Playlist(name=name, description=description)
...
def add_song():
    ...
    if form.validate_on_submit():
        ...
        new_s = Song(title=title, artist=artist)
